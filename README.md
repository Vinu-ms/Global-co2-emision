...
Tools & Technologies
Python (pandas, numpy, matplotlib, reportlab) | Data cleaning, transformation, and report generation Tableau | Interactive dashboard creation and visual analytics Excel | Data validation and exploration CSV / PDF | Data storage and output formats
